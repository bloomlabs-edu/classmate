...
const ICONS = {
  ...
  /**
   * The five below exist for config/subjectIconConfig.js's per-subject
   * mapping (see ExistingSubjectsList.js) — added together as one
   * small batch for that one purpose, not a general icon-set expansion.
   */
  calculator:
